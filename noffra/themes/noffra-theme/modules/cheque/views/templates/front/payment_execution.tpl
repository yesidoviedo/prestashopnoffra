	...
	<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
		<div class="box cheque-box">
			...
			<h3>
				...
				{if $use_taxes == 1}
					<small>{l s='(tax incl.)' mod='cheque'}</small>
				{/if}
			</h3>
			<p><strong>Pague a nombre de:</strong><br>
				NOFFRA 2000 C.A.</p>
			<p><strong>Cuentas bancarias:</strong><br>	
				Banesco: 0134-0192-60-1923014280<br>
				Banco Mercantil: 0105-0082-62-8082025247<br>
				Banco Bicentenario: 0175-0573-42-0074952271<br>
				Banco del Tesoro: 0163-0613-40-6133006289<br>
				Banco de Venezuela: 0102-0171-39-0001010248</p>
			<p><strong>Dirección:</strong><br>
				Calle 103 con Avenida 66, Local Parcela Nro. 16 y 17, Zona Industrial Castillito. San Diego. Valencia. Estado Carabobo. <br>
