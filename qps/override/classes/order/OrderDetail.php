...
class OrderDetail extends OrderDetailCore
{
   ...
   /** @var int */
    public $product_quantity_request;
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'product_quantity_request' =>    array('type' => self::TYPE_INT, 'validate' => 'isInt', 'required' => true),
    ...
    protected function create(Order $order, Cart $cart, $product, $id_order_state, $id_order_invoice, $use_taxes = true, $id_warehouse = 0)
    {
        ...
        $this->product_quantity_request = (int)$product['cart_quantity'];
    ...
    */
    ...
    public function add($autodate = true, $null_values = false)
    {
        ...
        return ObjectModel::add($autodate = true, $null_values = false);
    }
