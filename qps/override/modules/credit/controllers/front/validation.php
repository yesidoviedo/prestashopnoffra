 ...
 * @since 1.5.0
 */
class CreditValidationModuleFrontControllerOverride extends CreditValidationModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		$this->context->smarty->assign(array(
			'id_state' => $id_state,
			'max_payment_days'=>$this->context->customer->max_payment_days, 
			'total' => $this->context->cart->getOrderTotal(true, Cart::BOTH),
