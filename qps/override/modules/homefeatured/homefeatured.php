		...
		if (!$this->isCached('homefeatured.tpl', $this->getCacheId()))
		{
			...
			$this->smarty->assign(
				array(
					...
					// Grupo por defecto usado para no mostrar los precios por volúmenes para los clientes de Florida
					'customerDefaultGroup' => $this->context->customer->id_default_group,
