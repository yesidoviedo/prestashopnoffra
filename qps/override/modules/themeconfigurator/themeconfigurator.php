...
class ThemeConfiguratorOverride extends Module
{
	...
	public function __construct()
	{
		...
		$this->admin_tpl_path = _PS_THEME_DIR_.'/modules/'.$this->name.'/views/templates/admin/';
		$this->hooks_tpl_path = _PS_THEME_DIR_.'/modules/'.$this->name.'/views/templates/hooks/';
	}
	...
	public function hookDisplayFooterContact()
	{
		$this->context->smarty->assign(array(
			'htmlitems' => $this->getItemsFromHook('footercontact'),
			'hook' => 'footercontact'
		));
