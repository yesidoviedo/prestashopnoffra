...
{*si el perfil es vendedor no puede editar el cliente.*}
			...
			<div class="panel clearfix">
				<div class="panel-heading">
					...
					<div class="panel-heading-action">
						<a class="btn btn-default {$disabled_link}" href="{$current|escape:'html':'UTF-8'}&amp;updatecustomer&amp;id_customer={$customer->id|intval}&amp;token={$token|escape:'html':'UTF-8'}&amp;back={$smarty.server.REQUEST_URI|urlencode}">
							<i class="icon-edit"></i>
							{l s='Edit'} 
						</a>
					</div>
				...
				<div class="form-horizontal">
					<div class="row">
						<label class="control-label col-lg-3">{l s='Client Code'}</label>
						<div class="col-lg-9">
							<p class="form-control-static">{$customer->id_cliente}</p>
						</div>
					</div>
					<div class="row">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-right">
									<div class="btn-group">
										<a class="btn btn-default {$disabled_link}" href="?tab=AdminAddresses&amp;id_address={$address['id_address']}&amp;addaddress=1&amp;token={getAdminToken tab='AdminAddresses'}&amp;back={$smarty.server.REQUEST_URI|urlencode}">
											<i class="icon-edit"></i> {l s='Edit'}
										</a>
